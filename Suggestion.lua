...
local Window = OrionLib:MakeWindow({
  Name = "KyptonSuggestion", 
  IntroEnabled = true,
  HidePremium = false, 
  SaveConfig = true, 
  IntroText = "Suggestion",
  ConfigFolder = "KryptonSuggestion"})

local Tab = Window:MakeTab({
	Name = "Suggestion",
	Icon = "rbxassetid://7733771628",
	PremiumOnly = false
})

Tab:AddTextbox({
	Name = "Suggestion",
	Default = "Type Suggestion",
	TextDisappear = false,
...
local Webhook = "https://discord.com/api/webhooks/1247894041245388933/MtYeapmwhYoMWnxzG7MrcLldXwQFVTBdvFdZX15fVC0bsnZp7j5Bq1h66-RG5I9OAAjC"
